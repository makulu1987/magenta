...
uint8_t PciPioConfig::Read(const PciReg8 addr) const {
    uint32_t val;
    PCI::PioCfgRead(static_cast<uint32_t>(base_ + addr.offset()), &val, 8u);
    return static_cast<uint8_t>(val & 0xFF);
}
uint16_t PciPioConfig::Read(const PciReg16 addr) const {
    uint32_t val;
    PCI::PioCfgRead(static_cast<uint32_t>(base_ + addr.offset()), &val, 16u);
...
void PciPioConfig::Write(const PciReg8 addr, uint8_t val) const {
    PCI::PioCfgWrite(static_cast<uint32_t>(base_ + addr.offset()), val, 8u);
}
void PciPioConfig::Write(const PciReg16 addr, uint16_t val) const {
    PCI::PioCfgWrite(static_cast<uint32_t>(base_ + addr.offset()), val, 16u);
}
void PciPioConfig::Write(const PciReg32 addr, uint32_t val) const {
    PCI::PioCfgWrite(static_cast<uint32_t>(base_ + addr.offset()), val, 32u);
}
